...
const categories = [
	{
		id: 'Descrição',
		children: [
			{ id: 'Ordens', icon: <DnsRoundedIcon />, page: 'Ordens' },
			{ id: 'Gestão De Tributos', icon: <SettingsEthernetIcon />, page: 'Tributos' },
			{ id: 'Gestão De Vendas', icon: <SettingsInputComponentIcon />, page: 'Vendas' },
		],
	},
	{
		id: 'Predição',
...
const styles = theme => ({
	...
	colorPalleteTestMuiListRoot: {
		backgroud: "#B78A47"
	},
	colorPalleteTestMuiListItemGutters: {
		backgroud: "black"
	},
})
